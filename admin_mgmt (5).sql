...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2022 at 11:51 PM
...
CREATE TABLE `balance_history` (
  ...
  `bh_description2` text DEFAULT NULL,
  `bh_images` text DEFAULT NULL,
...
CREATE TABLE `notifications` (
  ...
  `user_id` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
(2, 'Eino Littlekjhkk hkjhk jh', 'Recusandae sit quia pariatur cumque.', 'Velit corporis quia esse ullam in.', 213.00, 1, 622.00, 15.00, NULL, 607.00, NULL, '[\"1646350060_admin_panel.jpg\",\"1646350067_Background-removal-service-Portfolio-1.jpg\"]', '2022-03-01 09:42:56', '2022-03-07 06:00:44'),
(3, 'iuouo', NULL, 'iuio', 9878.00, 1, 3.00, 1.00, NULL, 2.00, NULL, '[\"1646350237_ad1.jpg\"]', '2022-03-04 07:36:29', '2022-03-06 03:14:29');
...
(30, 2, 2, 2, 426, 1, 'pending', '2022-03-07 05:01:49', '2022-03-07 05:02:20'),
...
CREATE TABLE `purchase_details` (
  ...
  `pd_remarks` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `purchase_details` (`pd_id`, `purchase_id`, `pd_quantity`, `pd_username`, `pd_password`, `pd_start_date`, `pd_end_date`, `pd_remarks`, `pd_status`, `pd_read`, `pd_price`, `pd_creation_date`, `pd_updated_date`) VALUES
(20, 29, 1, NULL, NULL, NULL, NULL, NULL, 'pending', 0, 213.00, '2022-03-07 05:01:34', '2022-03-07 05:01:34'),
(21, 30, 1, NULL, NULL, NULL, NULL, NULL, 'rejected', 0, 213.00, '2022-03-07 05:01:49', '2022-03-07 05:06:03'),
(22, 30, 1, 'iyiy', 'iyiyiuy', '2022-03-01', '2022-03-22', NULL, 'accepted', 0, 213.00, '2022-03-07 05:01:49', '2022-03-07 05:54:28'),
(23, 31, 1, 'utut', 'ututut', '2022-03-01', '2022-03-21', NULL, 'accepted', 0, 213.00, '2022-03-07 06:00:44', '2022-03-07 06:02:36');
...
(2, 'user', 'User', 'User', 'Dummy', 'user@gmail.com', NULL, '$2y$10$Sd4Ot8wz1GbDV5gZMyiXReT3ouxX8MNah9IWctkhqmNrNdDM6soIu', '225-111-1023', NULL, 'uiyi', 'iyiuy', 'iuyiuyiuy', '', 5000, 4987.00, NULL, '2022-02-25 21:58:04', '2022-03-07 06:46:33'),
(4, 'user2', NULL, 'Ludwig', 'Zemlak', 'your.email+faker51041@gmail.com', NULL, '$2y$10$rju6hfDfIDJxpMIl/rzda.EXIjr/6S9ytYHAxcE3EOyad3r9Ry.jy', '353-046-3289', '039-398-0378', 'oiuiuiouiouiojlk kjkj', 'Corporis est sit.', '772-739-8134', '01646172469-avatar.png', 7096, 7096.00, NULL, '2022-03-01 05:04:22', '2022-03-04 12:07:24');
...
--
ALTER TABLE `balance_history`
  MODIFY `bh_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
