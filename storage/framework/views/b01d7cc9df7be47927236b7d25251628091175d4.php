                            ...
                            <table class="table zero-configuration">
                               ...
                               <tbody>
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    ...
                                    <td><?php echo e($comp->purchases->users->username); ?></td>  
                                    <td><?php echo e($comp->purchases->products->name); ?></td>  
                                    <td><?php echo e($comp->pd_creation_date); ?></td>  
                                    <td><?php echo e(getenv('CURRENCY')); ?> <?php echo e($comp->purchases->products->price); ?></td>  
                                    <td><?php echo e($comp->pd_quantity); ?></td>  
                                    <td>
                                        <?php echo e($comp->pd_status); ?> <br/>
                                    </td>
                                    <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin_mgmt\resources\views/users/pending_requests.blade.php ENDPATH**/ ?>