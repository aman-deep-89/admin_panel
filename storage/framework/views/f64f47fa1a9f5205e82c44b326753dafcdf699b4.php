        ...
        <div class="card-content">
          <div class="card-body">
            <div class="row">
                ...
                <?php endif; ?>  
                <form action="<?php echo e(route('user.store')); ?>" class="needs-validation" method="post">
                <div class="row">
                  <div class="col-md-8">               
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="username" name="username"  required placeholder="Enter username" value="<?php echo e(old('username')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="first_name" name="first_name"  required placeholder="Enter first_name" value="<?php echo e(old('first_name')); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="last_name">User Last Name *</label>
                      <input type="text" class="form-control" id="last_name" name="last_name" required  placeholder="Enter last_name" value="<?php echo e(old('last_name')); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="phone_no">Phone no *</label>
                      <input type="text" class="form-control" id="phone_no" name="phone_no" required  placeholder="Enter Phone No" value="<?php echo e(old('phone_no')); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="alternate_phone_no">Alternate Phone no <small>(optional)</small></label>
                      <input type="text" class="form-control" id="alternate_phone_no" name="alternate_phone_no"  placeholder="Enter Alternate Phone number" value="<?php echo e(old('alternate_phone_no')); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="internal_data">Internal Data *</label>
                      <input type="text" class="form-control" id="internal_data" name="internal_data" required placeholder="Enter Internal data" value="<?php echo e(old('internal_data')); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="initial_balance">Initial Balance *</label>
                      <input type="text" class="form-control" id="initial_balance" name="initial_balance" required placeholder="Enter initial_balance" value="<?php echo e(old('initial_balance')); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="vendor">Vendor *</label>
                      <input type="text" class="form-control" id="vendor" name="vendor" required placeholder="Enter Vendor" value="<?php echo e(old('vendor')); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="business_type">Business Type *</label>
                      <input type="text" class="form-control" id="business_type" name="business_type" required placeholder="Enter business type" value="<?php echo e(old('business_type')); ?>">
                    </fieldset>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="image-wrapper" style="height:220px;">
                      <img src="<?php echo e(asset('images/logo/logo.png')); ?>" class="avatar image1" width="200px" height="200px">
...
$(function() {
  $('#username').keyup(function(e) {
    ...
    $.ajax({
      ...
      data:"name="+txt+"&id=0&_token=<?php echo e(csrf_token()); ?>",
      type:'post',
      dataType:'json',
      beforeSend:function() {
        $('#username_error').html("");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin_mgmt\resources\views//users/create.blade.php ENDPATH**/ ?>