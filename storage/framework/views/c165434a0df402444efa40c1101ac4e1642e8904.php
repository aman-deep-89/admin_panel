...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center"><small class="mr-25">Already have an account?</small>
                  <a href="<?php echo e(asset('login')); ?>"><small>Sign in</small> </a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
            <img class="img-fluid" src="<?php echo e(asset('images/pages/register.png')); ?>" alt="branding logo">
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.fullLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin_mgmt\resources\views/auth/register.blade.php ENDPATH**/ ?>