...
<div class="row">
   <div class="col-md-12"><a href="<?php echo e(url('balance/add_request')); ?>" class="btn btn-primary">Add Balance</a></div>
</div>
                            ...
                            <table class="table zero-configuration">
                               ...
                               <tbody>
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    ...
                                    <td><?php echo e($comp->bh_status); ?></td>  
                                    <td>
                                        <?php if($comp->bh_status=='pending'): ?>
                                            <a href="<?php echo e(url('balance/edit_request', $comp->bh_id)); ?>" class="btn btn-sm btn-primary">Edit</a> <button type="button" class="btn btn-danger btn-sm delete" data-id="<?php echo e($comp->bh_id); ?>" data-route="<?php echo e(url('balance/delete_request', $comp->bh_id)); ?>" data-toggle="modal" data-target="#deleteDep">Delete</button>
                                        <?php endif; ?>
                                    </td>  
                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin_mgmt\resources\views/frontend/balance_history.blade.php ENDPATH**/ ?>