<?php $__env->startSection('title','Edit Balance'); ?>
        ...
        <div class="card-content">
          <div class="card-body">
            <div class="row">
                ...
                <?php endif; ?>  
                <?php if($list): ?>                                    
                <form action="<?php echo e(url('balance/edit_request')); ?>" class="needs-validation" method="post">
                <div class="row">
                  <div class="col-md-8"> 
                        <?php echo csrf_field(); ?>                        
                    <fieldset class="form-group">
                      <input type="hidden" id="request_id" name="request_id"  value="<?php echo e($list->bh_id); ?>" />
                      <label for="balance_amount">Balance Amount</label>
                      <input type="number" min="1" step="0.01" class="form-control" id="balance_amount" name="balance_amount" required  placeholder="Enter Amount" value="<?php echo e(old('balance_amount',$list->requested_amount)); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="date">Date</label>
                      <input type="text" class="form-control" id="date" name="date" required  placeholder="Enter Date" value="<?php echo e(old('date',date('d/m/Y',strtotime($list->date)))); ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <label for="description">Description <small>optional</small></label>
                      <textarea class="form-control" id="description" name="description" required  placeholder="Enter description"><?php echo e(old('description',$list->bh_description)); ?></textarea>
                    </fieldset>                    
                    <button class="btn btn-primary" type="submit">Save</button>
                  </div>
                  <div class="col-md-4">
                    <label for="formFileMultiple" class="form-label">Image</label>
                    <input type="hidden" id="filenames" name="filenames"  value="<?php echo e(old('filenames',$list->bh_images)); ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin_mgmt\resources\views/frontend/edit_balance.blade.php ENDPATH**/ ?>