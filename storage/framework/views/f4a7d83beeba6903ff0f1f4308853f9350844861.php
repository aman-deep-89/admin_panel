                            ...
                            <table class="table zero-configuration">
                               ...
                               <tbody>
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    <tr>  
                                    <td><?php echo e($comp->pd_id); ?></td>  
                                    <td><?php echo e($comp->purchases->name); ?></td>  
                                    <td><?php echo e($comp->pd_username); ?></td>  
                                    <td><?php echo e($comp->pd_password); ?></td>  
                                    <td><?php echo e($comp->pd_start_date); ?></td>  
                                    <td><?php echo e($comp->pd_end_date); ?></td>  
                                    <td><?php $comp->diff>0 ? $comp->diff.' Days' : '<span class="badge badge-danger">Expired</span>'; ?> </td>  
                                    <td> <?php echo e($comp->pd_status); ?> <br/> </td>
                                    <td><a href="<?php echo e(url('open_purchase_account/'.$comp->purchase_id)); ?>" class="btn btn-sm btn-primary">Open</a></td>
                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin_mgmt\resources\views/frontend/purchase_notifications.blade.php ENDPATH**/ ?>