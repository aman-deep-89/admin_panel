	    	...
	    	, saveImg = function(image) {
				...
				.done(function(response) {
					if (response.success) {
                        ...
                        var num=res1.length;
						if(options.dataEl)
						console.log("ele="+options.dataEl);
							$('#'+options.dataEl).val(res1[num-1]);
