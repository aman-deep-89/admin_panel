          ...
          <div class="card-body">
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    @endforeach
                @endif  
                <form action="{{url('balance/add_request') }}" class="needs-validation" method="post">
                <div class="row">
                  <div class="col-md-8">               
                        @csrf
                    ...
                    <fieldset class="form-group">
                      ...
                      <input type="text" class="form-control" id="date" name="date" required  placeholder="Enter Date" value="{{ old('date',date('d/m/Y')) }}">
                    </fieldset>
                    <fieldset class="form-group">
