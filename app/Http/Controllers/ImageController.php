...
class ImageController extends Controller
{
    private $config = array(
        ...
        'types' => array(
            ...
            'avatar' => array(
                'crop_width'  => 300,  // Crop image to this width
            ...
            'logo' => array(
                'crop_width'  => 500,  // Crop image to this width
                ...
                'min_height'  => 300,  // Minimum height required
                'max_width'   => null, // Maximum width allowed (null - not set)
                'max_height'  => null, // Maximum height allowed (null - not set)
            ...
            'small_logo' => array(
                ...
                'crop_height' => 100,  // Crop image to this height
                'force_crop'  => true, // If the image width, height is less than crop_width, crop_weight force the crop
                'min_width'   => 200,  // Minimum width required 
	...
	function __construct() {
		$this->upload_dir = public_path('images/avatar');
	}
	...
	public function save_cropped($data) {					
		...
		$this->json_success( asset('images/avatar')."/$filename" );
	}
    ...
    public function upload_image(Request $request) {
        $this->save_cropped($request->post());
    }
}